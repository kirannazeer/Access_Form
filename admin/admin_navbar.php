<nav class="navbar navbar-expand-lg navbar-dark bg-dark border-bottom">
    <div class="container-fluid">
        <a class="navbar-brand fw-bold" href="admin_home.php">
            <strong>AccessForm</strong> <span class="text-light-emphasis">- Admin</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-lg-center">
                    ...
                    <div class="dropdown-menu dropdown-menu-end p-4 shadow-lg border-0" 
                        ...
                        <div class="d-flex flex-column gap-2 mb-4">
                            <button onclick="setTheme('default')" id="btn-default" 
                                ...
                                <small class="text-muted">Standard theme</small>
                            </button>
                            ...
                            <button onclick="setTheme('high-contrast')" id="btn-high-contrast" 
                                ...
                                <small class="text-muted">Maximum visibility</small>
                            </button>
                ...
                <li class="nav-item"><a class="nav-link" href="admin_monitor_surveys.php">Monitor Surveys</a></li>
                <li class="nav-item"><a class="nav-link" href="admin_accessibility_compliance.php">Accessibility</a></li>
                
                <li class="nav-item">
                    <a class="nav-link text-danger fw-medium" href="logout.php">Logout</a>
                </li>
            </ul>
        </div>
    </div>
