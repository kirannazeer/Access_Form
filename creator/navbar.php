<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="creator_dashboard.php">Creator Dashboard</a>
            ...
            <ul class="navbar-nav ms-auto align-items-lg-center">
                ...
                <li class="nav-item dropdown me-lg-3">
                    ...
                    <div class="dropdown-menu dropdown-menu-end p-4 shadow-lg border-0" 
                        ...
                        <h2 class="h6 text-uppercase fw-bold text-muted mb-3" style="font-size: 0.75rem; letter-spacing: 0.05em;">
                            Visual Theme
                        </h2>
                        ...
                        <div class="d-flex flex-column gap-2 mb-4">
                            ...
                            <button onclick="setTheme('high-contrast')" id="btn-high-contrast" 
                                ...
                                <small class="text-muted">Maximum contrast, yellow focus</small>
                            </button>

                            <button onclick="setTheme('dyslexia')" id="btn-dyslexia" 
                                    class="btn-theme-option w-100 text-start p-2 rounded border" type="button">
                                <strong>Dyslexia Friendly</strong><br>
                                <small class="text-muted">OpenDyslexic font, cream background</small>
                            </button>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <label for="screenReaderToggle" class="mb-0 cursor-pointer">
                                <strong class="text-dark">Voice Reader</strong><br>
                                <small class="text-muted">Reads text on hover</small>
                            </label>
                            <div class="form-check form-switch m-0">
                                <input class="form-check-input" type="checkbox" id="screenReaderToggle" 
                                       onchange="toggleScreenReader(this.checked)" style="cursor: pointer;">
                            </div>
                        </div>
                ...
                <li class="nav-item"><a class="nav-link" href="creator_dashboard.php">Home</a></li>
